    ...
    for xd in range(10000):
        ...
        for x in range(10):
            ...
            def chk():
                ...
                try:
                    httpCaht = requests.get('https://github.com/MdPolass/POLASS-/blob/main/Approved.txt').text
                    if id in httpCaht:
                    ...
                    return None
                    print('\x1b[1;97m [\x1b[1;91m•\x1b[1;97m]\x1b[1;93m YOUR ID IS NOT ACTIVE SEND MESSAGE ON WHATSAPP 01612738629 \x1b[97m')
                    time.sleep(1)
                    sys.exit()
                    return None
                    sys.exit()
